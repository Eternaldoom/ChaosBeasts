...
public class ChaosClassTransformer implements net.minecraft.launchwrapper.IClassTransformer {
	...
	public byte[] transform(String arg0, String arg1, byte[] arg2) {
		...
		if (arg0.equals("afi")) {
			System.out.println("[ChaosBeastsCore] About to Patch: " + arg0);
	 ...
	 public byte[] patchClassASM(String name, byte[] bytes, boolean obfuscated) {
	      ...
	      //Now we loop over all of the methods declared inside the Explosion class until we get to the targetMethodName "doExplosionB"
	        ...
	        while(methods.hasNext())
	        {
	            ...
	            System.out.println("[ChaosBeastsCore] Method Name: "+m.name + " Desc:" + m.desc);
	            int fdiv_index = -1;
	          ...
	          //Check if this is doExplosionB and it's method signature is (Z)V which means that it accepts a boolean (Z) and returns a void (V)
	            ...
	            {
	                System.out.println("[ChaosBeastsCore] Inside target method!");
	              ...
	              //Loop over the instruction set and find the instruction FDIV which does the division of 1/explosionSize
	                while (iter.hasNext())
	                {
	                    ...
	                    System.out.println("[ChaosBeastsCore] index : " + index + " currentNode.getOpcode() = " + currentNode.getOpcode());
	                ...
	                System.out.println("[ChaosBeastsCore] fdiv_index should be 336 -> " + fdiv_index);
