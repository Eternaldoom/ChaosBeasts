...
public class ChaosTool extends Item
{
    ...
    protected ChaosTool(float p_i45333_1_, Item.ToolMaterial p_i45333_2_, Set p_i45333_3_)
    {
        ...
        if (this instanceof ChaosPick)
        {
            toolClass = "pickaxe";
        }
        else if (this instanceof ChaosAxe)
        {
            toolClass = "axe";
        }
        else if (this instanceof ChaosSpade)
        {
            toolClass = "shovel";
        }
    }
