...
public class ChaosInfiniteArmor extends ItemArmor implements ISpecialArmor
{
	 ...
	 * Normal constructor
	 */
	public ChaosInfiniteArmor(ArmorMaterial armor, int par1, int par2, double damReduct, String type)
	{
