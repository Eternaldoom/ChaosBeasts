...
public class ChaosCrafting
{
	public ChaosCrafting()
	{
        ...
        GameRegistry.addRecipe(new ItemStack(ChaosItems.lumpangelic), new Object[]{"BBB", "BBB", "BBB", 'B', ChaosBlocks.blockEnergyShard});
		GameRegistry.addRecipe(new ItemStack(ChaosBlocks.blockEnergyShard, 9), new Object[]{"L", 'L', ChaosItems.lumpangelic});
		...
		GameRegistry.addRecipe(new ItemStack(ChaosItems.helmetangelic), new Object[]{"RRR", "R R", "   ", 'R', ChaosItems.lumpangelic});
		GameRegistry.addRecipe(new ItemStack(ChaosItems.chestplateangelic), new Object[]{"R R", "RRR", "RRR", 'R', ChaosItems.lumpangelic});
		GameRegistry.addRecipe(new ItemStack(ChaosItems.leggingsangelic), new Object[]{"RRR", "R R", "R R", 'R', ChaosItems.lumpangelic});
		GameRegistry.addRecipe(new ItemStack(ChaosItems.bootsangelic), new Object[]{"   ", "R R", "R R", 'R', ChaosItems.lumpangelic});
		...
		GameRegistry.addRecipe(new ItemStack(ChaosItems.swordangelic), new Object[]{" R ", " R ", " S ", 'R', ChaosItems.lumpangelic, 'S', Items.stick});
		GameRegistry.addRecipe(new ItemStack(ChaosItems.spadeangelic), new Object[]{" R ", " S ", " S ", 'R', ChaosItems.lumpangelic, 'S', Items.stick});
		GameRegistry.addRecipe(new ItemStack(ChaosItems.pickaxeangelic), new Object[]{"RRR", " S ", " S ", 'R', ChaosItems.lumpangelic, 'S', Items.stick});
		GameRegistry.addRecipe(new ItemStack(ChaosItems.axeangelic), new Object[]{"RR ", "RS ", " S ", 'R', ChaosItems.lumpangelic, 'S', Items.stick});
		GameRegistry.addRecipe(new ItemStack(ChaosItems.hoeangelic), new Object[]{"RR ", " S ", " S ", 'R', ChaosItems.lumpangelic, 'S', Items.stick});
