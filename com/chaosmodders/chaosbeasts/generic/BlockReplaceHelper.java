    		...
    		for(Field field:Blocks.class.getDeclaredFields()){
        		if (Block.class.isAssignableFrom(field.getType())){
    				...
    				if (block==toReplace){
    					...
    					System.out.println("[ChaosBeasts]: Replacing block - "+id+"/"+registryName);
    					...
    					System.out.println("[ChaosBeasts]: Check field: "+field.get(null).getClass());
    					System.out.println("[ChaosBeasts]: Check registry: "+Block.blockRegistry.getObjectById(id).getClass());
    					System.out.println("[ChaosBeasts]: Check item: "+((ItemBlock)Item.getItemFromBlock(newBlock)).field_150939_a.getClass());
    				}
        		}
        	}
    	}catch(Exception e){
