package com.chaosmodders.chaosbeasts.entity.fx;
...
public class DoomPortalFX extends EntityFX
{
    ...
    public DoomPortalFX(World var1, double var2, double var4, double var6, double var8, double var10, double var12)
    {
