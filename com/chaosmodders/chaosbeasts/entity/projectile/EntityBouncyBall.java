...
public class EntityBouncyBall extends EntityThrowable
{
    public int damage;
    public EntityLivingBase thrower;
    protected int bounces;
    
    public EntityBouncyBall(World par1) {
        super(par1);
    }

    public EntityBouncyBall(World par1, EntityLivingBase par2, int par3) {
        super(par1, par2);
        this.damage = par3;
        this.thrower = par2;
    }

    public EntityBouncyBall(World par1, double par2, double par4, double par6) {
