...
public class RenderDoomTNT extends Render
{
    private RenderBlocks blockRenderer = new RenderBlocks();

    public RenderDoomTNT()
    {
     ...
     */
    public void doRender(EntityDoomTNT par1EntityTNTPrimed, double par2, double par4, double par6, float par8, float par9)
    {
        GL11.glPushMatrix();
