package com.chaosmodders.chaosbeasts.client.renderer.projectile;
...
{
    private static final ResourceLocation doomTextures = new ResourceLocation("textures/atlas/items.png");

    private Item field_94151_a;
    private int field_94150_f;
    private static final String __OBFID = "CL_00001008";

    public RenderThrowingStar(Item par1Item, int par2)
    {
        this.field_94151_a = par1Item;
        this.field_94150_f = par2;
    }

    public RenderThrowingStar(Item par1Item)
    {
        this(par1Item, 0);
    }
