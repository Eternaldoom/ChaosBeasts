...
public class BlockIronFence extends BlockFence
{
    ...
    public BlockIronFence(String p_i45406_1_, Material p_i45406_2_)
    {
    ...
    if (this.blockMaterial.isOpaque() && block.renderAsNormalBlock() && this.blockMaterial != Material.gourd)
    {
    return true;
    }
    return true;
