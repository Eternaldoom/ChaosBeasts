...
public class DarkWorldProvider extends WorldProvider {
	...
	public DarkWorldProvider()
	{
		this.skyRenderer = new DarkSkyRenderer();
	}
	
	public void registerWorldChunkManager() {
		this.worldChunkMgr = new WorldChunkManagerHell(ChaosBeasts.darkbiome,
				ChaosBeasts.DarkDimensionId);
		this.hasNoSky = true;
	}

	public IChunkProvider createChunkGenerator() {
		return new DarkChunkProvider(this.worldObj, this.worldObj.getSeed(),
				hasNoSky);
	}
