...
public class LightTeleporter extends Teleporter
{
    ...
    public LightTeleporter(WorldServer par1WorldServer) {
    ...
    public boolean placeInExistingPortal(Entity par1Entity, double par2, double par4, double par6, float par8)
    {
        ...
        {
            LightTeleporter.PortalPosition portalposition = (LightTeleporter.PortalPosition)this.destinationCoordinateCache.getValueByKey(j1);
            d3 = 0.0D;
        ...
        if (d3 >= 0.0D)
        {
            if (flag)
            {
                this.destinationCoordinateCache.add(j1, new LightTeleporter.PortalPosition(i, j, k, this.worldServerInstance.getTotalWorldTime()));
    ...
    public void removeStalePortalLocations(long par1)
    {
        if (par1 % 100L == 0L)
        {
            ...
            while (iterator.hasNext())
            {
                ...
                LightTeleporter.PortalPosition portalposition = (LightTeleporter.PortalPosition)this.destinationCoordinateCache.getValueByKey(olong.longValue());
