...
public abstract class LayerGenReplacer extends GenLayer
{
	 ...
	 * @param newBiomeId
	 */
	public LayerGenReplacer(final long worldSeed, final long seed, final GenLayer parent, double noiseScale, double noiseThreshold, int newBiomeId) {
		super(seed);
		this.parent = parent;
