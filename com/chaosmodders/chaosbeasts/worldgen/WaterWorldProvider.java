...
{
this.worldChunkMgr = new WorldChunkManagerHell(ChaosBeasts.waterbiome, this.dimensionId);
this.hasNoSky = true;
}
public IChunkProvider createChunkGenerator()
{
return new WaterChunkProvider(this.worldObj, this.worldObj.getSeed());
}
