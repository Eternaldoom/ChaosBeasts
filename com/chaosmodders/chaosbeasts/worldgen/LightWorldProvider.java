...
public class LightWorldProvider extends WorldProvider {
	private float[] colorsSunriseSunset = new float[4];

	public void registerWorldChunkManager() {
		this.worldChunkMgr = new WorldChunkManagerHell(ChaosBeasts.lightbiome,
				ChaosBeasts.LightDimensionId);
		this.hasNoSky = true;
	}

	public IChunkProvider createChunkGenerator() {
		return new ChunkProviderLight(this.worldObj, this.worldObj.getSeed());
	}
	...
	public String getSunTexture() {
		return "chaosbeasts:textures/environment/doomsun.png";
	}
