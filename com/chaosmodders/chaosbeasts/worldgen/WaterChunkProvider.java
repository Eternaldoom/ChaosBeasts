...
public class WaterChunkProvider implements IChunkProvider
{
    ...
    public WaterChunkProvider(World par1World, long par2)
    {
    ...
    public void func_147418_b(int p_147418_1_, int p_147418_2_, Block[] p_147418_3_)
    {
        ...
        for (int k = 0; k < 16; ++k)
        {
            for (int l = 0; l < 16; ++l)
            {
                ...
                int j1 = -1;
                Block block = ChaosBlocks.blockDarknessStone;
                Block block1 = ChaosBlocks.blockDarknessStone;
