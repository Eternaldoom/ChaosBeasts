package com.eternaldoom.chaosbeasts.entity.monster;
...
public class EntityHellLobster extends EntityMob
{
    ...
    public EntityHellLobster(World par1World)
    {
        super(par1World);
    ...
    protected void applyEntityAttributes()
    {
        ...
        this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(8.0D);
